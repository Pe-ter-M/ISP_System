  ...
  routes: [
    ...
    // ── Admin app (sidebar, no public header/footer) ──
    {
      ...
      children: [
        ...
        { path: 'subscriptions', name: 'subscriptions', component: () => import('../views/admin/SubscriptionsView.vue'), meta: { title: 'Subscriptions' } },
        { path: 'plans', name: 'admin-plans', component: () => import('../views/admin/PlansView.vue'), meta: { title: 'Plans' } },
        { path: 'sessions', name: 'sessions', component: () => import('../views/admin/PlaceholderView.vue'), meta: { title: 'Live Sessions' } },
        { path: 'nas', name: 'nas', component: () => import('../views/admin/NasView.vue'), meta: { title: 'NAS Clients' } },
        { path: 'users', name: 'admin-users', component: () => import('../views/admin/UsersView.vue'), meta: { title: 'Users' } },
        { path: 'users/customers', name: 'admin-users-customers', component: () => import('../views/admin/CustomersView.vue'), meta: { title: 'Customers' } },
        { path: 'users/staff', name: 'admin-users-staff', component: () => import('../views/admin/PlaceholderView.vue'), meta: { title: 'Staff' } },
